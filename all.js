...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _StaggeredMotion = __webpack_require__(15);
	
	exports.StaggeredMotion = _interopRequire(_StaggeredMotion);
	
	var _TransitionMotion = __webpack_require__(16);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(1),m=__webpack_require__(22),A=__webpack_require__(12),B=__webpack_require__(3),ca=__webpack_require__(21),da=__webpack_require__(25),ea=__webpack_require__(29),ha=__webpack_require__(23),ia=__webpack_require__(24),C=__webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	'use strict';var m=__webpack_require__(12),n=__webpack_require__(11),p=__webpack_require__(3);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _srcReactMotion = __webpack_require__(18);
	...
	var Demo = (function (_React$Component) {
	  ...
	  function Demo(props) {
	    ...
	    this.handleChange = function (_ref3) {
	    ...
	    this.getDefaultStyles = function () {
	      return _this.state.friends.map(function (friend) {
	        return _extends({}, friend, { style: { height: 0, opacity: 1 } });
	      });
	    };
	    ...
	    this.getStyles = function () {
	      ...
	      var keyNames = _this.keyNames;
	
	      return friends.filter(function (_ref4) {
	        var _ref4$data = _ref4.data;
	        var text = _ref4$data.text;
	        var info = _ref4$data.info;
	
	        // console.log(info);
	        for (var i = 0; i < keyNames.length; i++) {
	          var key = keyNames[i];
	          if (info[key] && info[key].indexOf(value) >= 0) {
	            return true;
	          }
	        }
	        return false;
	      }).map(function (friend, i) {
	        return _extends({}, friend, {
	          style: {
	    ...
	    var keyNames = ['最近一直喜欢滴三样事情写代码读书音乐吃和喜欢的人在一起', '最近一直喜欢滴三样食物宫爆鸡丁早茶饮料塑料', '最近一直感兴趣滴人周杰伦某youtuber柯南罗永浩她他'];
	  ...
	  Demo.prototype.findHint = function findHint(info, value) {
	    var keyNames = this.keyNames;
	
	    for (var i = 0; i < keyNames.length; i++) {
	      var key = keyNames[i];
	      if (info[key] && info[key].indexOf(value) >= 0) {
	        return info[key].substr(info[key].indexOf(value), 10) + '...';
	      }
	    }
	  };
	  ...
	  Demo.prototype.componentDidMount = function componentDidMount() {
	    ...
	    var url = 'http://gsx2json.com/api?id=1Kts21l1mIepkhnXF6DrdGWbG2SMwwQEJMKjaLI500rA';
	
	    $.getJSON(url, function (data) {
	      _this2.rows = data.rows;
	
	      _this2.setState({
	        friends: _this2.rows.map(function (row) {
	          return {
	            key: row['代号名字'] + '',
	            data: {
	              text: row['代号名字'],
	          ...
	          props: {
	            children: [{
	              ...
	              props: {
	                ...
	                style: { display: friends.length === 0 ? 'none' : 'inline' }
	              },
	              _owner: null
	            }, {
	              $$typeof: _typeofReactElement,
	              ...
	              props: _defaultProps(_srcReactMotion.TransitionMotion.defaultProps, {
	                children: function children(styles) {
	                  return {
	                    ...
	                    ref: null,
	                    props: {
	                      children: styles.map(function (_ref5) {
	                        var key = _ref5.key;
	                        var style = _ref5.style;
	                        var _ref5$data = _ref5.data;
	                        var text = _ref5$data.text;
	                        var info = _ref5$data.info;
	                        return {
	                          $$typeof: _typeofReactElement,
	                          type: 'li',
	                          key: key,
	                                ...
	                                children: {
	                                  ...
	                                  props: {
	                                    children: [text, {
	                                      ...
	                                      ref: null,
	                                      props: {
	                                        children: !value ? '' : '   ' + _this3.findHint(info, value),
	...
	// logic from friend, unrelated to animation
